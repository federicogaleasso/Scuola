#GALEASSO FEDERICO 4C 19/12/2022 ESERCIZIO IN CLASSE - ANIMALE OOP CON OPERATOR OVERLOADING
...
#+ e - dei pesi con operator overloading, * e / ...
...
class Animale:
	...
	def __add__(self,other):
		peso=self.getPeso()+other.getPeso()
		return getPeso(peso)
